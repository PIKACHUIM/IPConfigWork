...
(function () {
    ...
    function calculateOverallScore(mergedQuality, mergedDetail, isDC, isVPN, isProxy, isTor) {
        ...
        if (overallScoreRing) {
            ...
            // 更新等级文本
            var overallLevel = document.getElementById('overallLevel');
            if (overallLevel) {
                overallLevel.textContent = levelText;
                overallLevel.setAttribute('data-i18n', levelKey);
            }
        }
